        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-[720px]">
              ...
              <p className="mt-4">
              Hi, I'm Ashir Shaikh, A MERN stack developer proficient in React, Next.js, and API design. With a focus on crafting modular components, I excel in building dynamic and responsive user interfaces. My expertise extends to both front-end and back-end development, allowing me to seamlessly connect the dots in full-stack web projects. I'm passionate about creating visually appealing designs that complement robust functionality. Let's collaborate to turn your ideas into a compelling and efficient web experience. I'm driven to constantly learn and explore new technologies, and I'm eager to expand my expertise further. If you're looking for a developer enthusiastic about taking on challenges and committed to continuous growth, let's connect!
              </p>
            </div>
